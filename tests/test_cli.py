...
class TestCliCommands:
    ...
    def test_terraform_setup_before_prep_teardown_after_apply(self, mocker):
        ...
        tfc.app_state.handlers.exec_setup.side_effect = lambda **kw: call_order.append("setup")
        tfc.prep_providers.side_effect = lambda: call_order.append("prep_providers")
        tfc.terraform_apply_or_destroy.side_effect = lambda: call_order.append("apply_or_destroy")
        tfc.app_state.handlers.exec_teardown.side_effect = lambda **kw: call_order.append("teardown")
