...
def pipe_exec(
    ...
    """
    commands: List[subprocess.Popen] = []  # listed used to hold all the popen objects
    ...
    popen_stdin_kwargs: Dict[str, Any] = {}
    ...
    for idx, cmd_str in enumerate(args):
        lastloop = True if len(args) - 1 == idx else False
    ...
    if stream_output is True:
        ...
        if len(commands) > 1:
            ...
            if stdin is not None:
                commands[0].communicate(input=stdin)
